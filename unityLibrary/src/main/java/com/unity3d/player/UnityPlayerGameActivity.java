...
public class UnityPlayerGameActivity extends GameActivity implements IUnityPlayerLifecycleEvents, IUnityPermissionRequestSupport, IUnityPlayerSupport
{
    ...
    private void ApplyInsetListener(SurfaceView surfaceView)
    {
        surfaceView.getViewTreeObserver().addOnGlobalLayoutListener(
            () ->
            {
                // Workaround an issue where native GameActivity layer tries to access null insets
                // java_vm_ext.cc:591] JNI DETECTED ERROR IN APPLICATION: JNI CallStaticIntMethodV called with pending exception java.lang.NullPointerException: Attempt to invoke virtual method 'androidx.core.graphics.Insets androidx.core.view.WindowInsetsCompat.getInsets(int)' on a null object reference
                //                                                                                                    java_vm_ext.cc:591]   at androidx.core.graphics.Insets com.google.androidgamesdk.GameActivity.getWindowInsets(int) (GameActivity.java:497)
                //                                                                                                    java_vm_ext.cc:591]   at void com.google.androidgamesdk.GameActivity.onWindowInsetsChangedNative(long) (GameActivity.java:-2)
                //                                                                                                    java_vm_ext.cc:591]   at androidx.core.view.WindowInsetsCompat com.google.androidgamesdk.GameActivity.onApplyWindowInsets(android.view.View, androidx.core.view.WindowInsetsCompat) (GameActivity.java:486)
                //                                                                                                    java_vm_ext.cc:591]   at void com.unity3d.player.UnityPlayerGameActivity.lambda$ApplyInsetListener$0(android.view.SurfaceView) (UnityPlayerGameActivity.java:70
                // Happens when playing full screen video, which causes views to be rearranged
                if (ViewCompat.getRootWindowInsets(this.mSurfaceView) == null)
                    return;
